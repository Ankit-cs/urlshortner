          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {user ? (
              <div className="relative">
                ...
                {showAuthDropdown && (
                  <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-[#111111] border border-black/10 dark:border-white/10 rounded-xl shadow-lg z-50 overflow-hidden">
                    ...
                    <button 
                      ...
                      className="w-full text-left px-4 py-2 text-sm text-black dark:text-white hover:bg-gray-50 dark:hover:bg-white/5 transition-colors border-b border-black/10 dark:border-white/10"
                    >
                      Dashboard
                    </button>
                    <button                        onClick={() => {
