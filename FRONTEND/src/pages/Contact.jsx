      ...
      <div className="max-w-4xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">hello@example.com</p>
          </a>
          ...
          >
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">github.com</p>
          </a>
        </div>
